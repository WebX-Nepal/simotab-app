...
import {  InsertSocialMediaLinkHandler, createUserHandler, getAllUserHandler, getSingleUserHandler, loginUserHandler, updateUserCoverImageHandler, updateUserProfileImageHandler , } from '../controllers/user'
...
router.post("/users/insert-social-media",checkAuth,InsertSocialMediaLinkHandler as any)
