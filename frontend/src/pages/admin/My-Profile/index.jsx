...
import { BsFacebook, BsGithub, BsInstagram, BsLinkedin, BsSnapchat, BsTiktok, BsTwitter, BsWhatsapp, BsYoutube } from "react-icons/bs";
        ...
        <div className="profile-wrapper">
          ...
          <div className="second-wrapper">
            ...
            <div className="add-to-phone">
              <button className="add-to-phone-button">Add to your Phone</button>
            </div>
                ...
                <div key={socialMediaLink._id} className="">
                  {
                    elements.map((element)=>{
                        ...
                        return (
                          ...
                          <Link key={element.id} to={socialMediaLink.url} target="_blank">
                          <span  className="text-7xl">
                            
                        {element.name===socialMediaLink.name?element.component:""}
                      </span>
                          </Link>
                      )
