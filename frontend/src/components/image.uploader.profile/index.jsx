...
function ProfileImageUpload(props) {
  ...
  const handleUploadButtonClick =async() => {
    ...
    if(image){
      ...
      const response=await updateDataWithHeader('update-user-profile-image',formdata,token)
      console.log(response)
      if(response.success){
        successToast(response.message?response.message:"Profile picture updated successfully")
        dispatch(loadUser(response.updatedUser))
        props.handleCloseProfilePictureModel()
      }
    }
  }
      ...
      <div className="box-decoration">
        ...
        <div onClick={handleClick} style={{ cursor: "pointer" }}>
          {image ? (
            ...
            <img src={current_user_info?.profileImageUrl?.url
...
ProfileImageUpload.propTypes={
  handleCloseProfilePictureModel:PropTypes.func
